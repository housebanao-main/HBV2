...
<a href="https://api.whatsapp.com/send?phone=9810117643" target="_blank" rel="noopener noreferrer" className={`${style} top-[118px]`}>
  <Image src={whatsappicon} alt='whatsapp' className='w-[30px]' />
</a>
<a href="tel:+919810232124" className={`${style} top-[180px]`}>
